...
{
    [RuleInfo("AzActLogAlertChangeNetworkSecGrpRule", Scope.Azure, MaturityLevel.Mature, "https://portal.azure.com/#blade/Microsoft_Azure_Monitoring/AzureMonitoringBrowseBlade/alertsV2", Service.StorageAccount)]
    [RuleScore("For this subscription exists no Activity Log Alert for 'Changeing a Network Security Group Alerts'", "Good monitoring can reduce the time it takes to detect unsolicited changes.", 0)]
