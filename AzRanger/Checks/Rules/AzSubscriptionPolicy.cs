...
namespace AzRanger.Checks.Rules
{
    ...
    [RuleInfo("User can move Subscriptions in and out of Azure Active Directory", "This increases the risk, that a bad actor moves an subscription to a Tenant, where he has more permissions.", 6, "https://www.cloud-architekt.net/detection-and-mitigation-consent-grant-attacks-azuread/", null, @"Go to the reference lin an set ""Subscription leaving AAD directory"" and ""Subscription entering AAD directory "" to ""Permit no one"".")]
