...
namespace AzRanger.Checks
{
    ...
    [RuleInfo("The Tenant is no configured for a bad password list", "This increases the risk, users uses easy guessable password.", 4, null, null, @"1. Go to Entra Admin Center </br> 2. Go to Protection </br> 3. Go to Authentication methods</br> 4. Go to Password protection </br> 5. 4. Ensure Enforce custom list is set to Yes.")]
