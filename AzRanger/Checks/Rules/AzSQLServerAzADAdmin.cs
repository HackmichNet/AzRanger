...
namespace AzRanger.Checks.Rules
{
    ...
    [RuleInfo("Azuer AD Authentication is not enabled for SQL-Server", "This could be an addtional risk to the SQL Server. It eases attacks like password bruteforce.", 1, null, null, @"For each SQL-Server go to ""Settings"" and ""Azure Active Directory"". Here click on ""Set Admin"" and choose an admin.")]
