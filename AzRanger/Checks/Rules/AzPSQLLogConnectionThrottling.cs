...
namespace AzRanger.Checks.Rules
{
    ...
    [RuleInfo("Log Disconnection are disabled", @"You might miss problems and errors in PSQLQueries.", 1, null, null, @"For each PSQLServer go to Settings->Server parameters and search for ""connection_throttling"". Set the value to ""On"".")]
    [CISAZ("4.3.5", "", Level.L1, "v2.0")]
