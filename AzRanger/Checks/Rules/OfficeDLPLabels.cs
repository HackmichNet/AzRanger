...
namespace AzRanger.Checks.Rules
{
    ...
    [RuleInfo("The tenant has no DLP Label Policies", "This increases the risk of unwanted data loss.", 0, "https://learn.microsoft.com/en-us/microsoft-365/compliance/dlp-learn-about-dlp?view=o365-worldwide#deploy-your-policies-in-production", null, "Go to the Portal URL and set the DLP label policies according to your needs.")]
