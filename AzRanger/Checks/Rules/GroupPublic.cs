...
namespace AzRanger.Checks.Rules
{
    ...
    [RuleInfo("Your tenant contains public groups", "This can bypass some security controls for group protected data, if every user can add himself to a group.", 3, "https://www.dummies.com/software/microsoft-office/office-365-groups/", null, @"Go to the Portal URL and review all public groups and check if they are needed.")]
