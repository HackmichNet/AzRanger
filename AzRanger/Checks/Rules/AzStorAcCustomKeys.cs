...
namespace AzRanger.Checks.Rules
{
    ...
    [RuleInfo("StorageAccount is encrypted with Microsoft Managed Keys", "Microsoft may have access to your encrypted data.", 1, null, null, "If you want to have control over your keys, you should use custom keys.")]
