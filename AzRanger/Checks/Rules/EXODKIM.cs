...
namespace AzRanger.Checks.Rules
{
    ...
    [RuleInfo("Not all of the Exchange Online Domains have DKIM enabled", "This increases the risk, that an attacker can impersonate your domain.", 5, null, null, "Configure DKIM for all your domains.")]
