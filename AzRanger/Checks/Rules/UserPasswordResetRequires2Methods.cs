...
namespace AzRanger.Checks.Rules
{
    ...
    [RuleInfo("Password Self-ServiceEnum does not require two methods for reset", "This increases the risk, that a threat actor can perform a password reset for a user.", 1, null, null, @"1. Go to Azure Active Directory </br> 2. Go to Users </br> 3. Go to Password reset </br> 4. Go to Authentication methods </br> 5. Set the Number of methods required to reset to 2")]
