...
namespace AzRanger.Checks.Rules
{
    ...
    [RuleInfo("Word, Excel and PowerPoint add-ins are allowed", "Attackers can misuse add-ins for malicious purpose.", 4, null, null, @"Go to the Portal URL and uncheck ""Let users access the Office Store"" and ""Let users start trials on behalf of your organization"".")]
