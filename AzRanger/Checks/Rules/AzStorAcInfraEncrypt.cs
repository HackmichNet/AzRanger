...
namespace AzRanger.Checks.Rules
{
    ...
    [RuleInfo("StorageAccounts does not require infrastructure encryption", "Encrypting data on the hardware level provides an additional protection against data loss.", 0, null, null, @"You cannot enable this for already existent Storage Accounts. You must create new one and on the tap ""Encryption"" choose the right options.")]
