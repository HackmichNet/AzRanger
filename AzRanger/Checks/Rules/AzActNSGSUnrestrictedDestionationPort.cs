...
namespace AzRanger.Checks.Rules
{
    ...
    [RuleInfo("Network Security Group without inbound port restriction", "The service protected by the Network Security Group is exposed to the internet.", 0, null, null, "Configure the Network Security Group that only needed inbound ports are allowed.")]
