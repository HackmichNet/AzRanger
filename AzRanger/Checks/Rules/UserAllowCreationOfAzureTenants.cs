...
{
    [RuleMeta("UserAllowCreationOfAzureTenants", Scope.O365, MaturityLevel.Mature, "https://portal.azure.com/#view/Microsoft_AAD_UsersAndTenants/UserManagementMenuBlade/~/UserSettings")]
    ...
    class UserAllowCreationOfAzureTenants : BaseCheck
    {
        ...
        {
            if (tenant.AuthorizationPolicy.defaultUserRolePermissions.allowedToCreateTenants == true)
            {
