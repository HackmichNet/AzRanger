...
namespace AzRanger.Checks.Rules
{
    ...
    [RuleInfo("User can access the Entra admin portal", "The Entra admin portal may contain sensitiv information.", 1, null, "Entra Admin portal contains sensitive information, which not everyone shoould be able to see.", @"1. Go to Entra admin center</b>2. Go to Users</br>3. Go to User settings</b>4. Set Restrict access to Azure AD administration portal to Yes")]
