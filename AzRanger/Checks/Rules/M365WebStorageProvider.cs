...
namespace AzRanger.Checks.Rules
{
    ...
    [RuleInfo("Third-party storage services are not restricted in M365 web", "This increases the risk of unwanted data loss.", 1, null, null, @"Go to the portal link and ensure that ""Let users open files stored in third-party storage services in Microsoft 365 on the web"" is not checked.")]
